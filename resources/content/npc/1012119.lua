...
function M.shops()
  return {
    ...
    },
    {
      ...
      name = "卷轴",
      items = {
        {item_id = "02043001", price = 50000},   -- 单手剑攻击卷轴 60%
        {item_id = "02043005", price = 150000},  -- 单手剑攻击卷轴 30%
        {item_id = "02043003", price = 200000},  -- 单手剑攻击必成卷
        {item_id = "02043701", price = 50000},   -- 短杖魔力卷轴 60%
        {item_id = "02043705", price = 150000},  -- 短杖魔力卷轴 30%
        {item_id = "02043703", price = 200000},  -- 短杖魔力必成卷
        {item_id = "02044501", price = 50000},   -- 弓攻击卷轴 60%
        {item_id = "02044505", price = 150000},  -- 弓攻击卷轴 30%
        {item_id = "02044503", price = 200000},  -- 弓攻击必成卷
      }
    },
  }
end
...
function M.entries(ctx)
  return {
    ...
    },
    {
      ...
      reward_exp = 2000,
      reward_money = 8888,
      reward_items = { { 2043001, 3 } },
      accept_yes = { "有委托人下了笔大单子：#r30 个 #t2000000#、10 个 #t2000003##k。",
                     "办成了，佣金少不了你的。" },
      complete_yes = { "漂亮！这是佣金，还有几张 #t2043001# 顺手送你。" },
